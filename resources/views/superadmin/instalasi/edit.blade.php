...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" action="/superadmin/instalasi/edit/{{$data->id}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Kode instalasi</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="expired" class="form-control" value="{{$data->expired}}">
                    </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                    ...
                    <a href="/superadmin/instalasi" class="btn btn-outline-danger">Kembali</a>
                </div>
            </form>
            <!-- /.card-body -->
        </div>
