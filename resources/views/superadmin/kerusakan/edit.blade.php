...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" action="/superadmin/kerusakan/edit/{{$data->id}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="penanganan" class="form-control" value="{{$data->penanganan}}">
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer">
                    ...
                    <a href="/superadmin/kerusakan" class="btn btn-outline-danger">Kembali</a>
                </div>
            </form>
            <!-- /.card-body -->
        </div>
